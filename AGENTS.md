...
This project is indexed by GitNexus as **futuapi4go** (15272 symbols, 32662 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
