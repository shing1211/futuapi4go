...
This project is indexed by GitNexus as **futuapi4go** (15294 symbols, 32683 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
