...
This project is indexed by GitNexus as **futuapi4go** (13938 symbols, 28493 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
