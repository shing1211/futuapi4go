...
const (
	...
	SubType_KL_3Min      = int32(qot.SubType_KL_3Min)
	...
	SubType_KL_10Min     = int32(qot.SubType_KL_10Min)
	SubType_KL_120Min    = int32(qot.SubType_KL_120Min)
	SubType_KL_180Min    = int32(qot.SubType_KL_180Min)
	SubType_KL_240Min    = int32(qot.SubType_KL_240Min)
	...
	SubType_KL_Quarter   = int32(qot.SubType_KL_Quarter)
	SubType_KL_Year      = int32(qot.SubType_KL_Year)
	SubType_Broker       = int32(qot.SubType_Broker)
	SubType_OrderBookOdd = int32(qot.SubType_OrderBookOdd)
)
