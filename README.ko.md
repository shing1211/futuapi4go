...
| `GetHistoryKLQuota(ctx, c)` | API 할당량 사용량 |
...
| 함수 | 설명 |
|---|---|
| `Subscribe(ctx, c, market, code, []constant.SubType)` | 푸시 유형 구독 |
| `Unsubscribe(ctx, c, market, code, []constant.SubType)` | 구독 해제 |
